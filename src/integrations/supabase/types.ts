...
export type Holobot = Tables['holobots']['Row'];
export type Battle = Tables['battles']['Row'];
export type BattleParticipant = Tables['battle_participants']['Row'];
export type TrainingReward = Tables['training_rewards']['Row'];
export type UserMissionRow = Tables['user_missions']['Row'];

export interface UserMission extends UserMissionRow {}
